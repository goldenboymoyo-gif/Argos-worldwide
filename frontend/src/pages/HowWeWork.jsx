    ...
    <>
      ...
      <div className="border-t border-argos-gray-lighter">
        {steps.map((step) => {
          ...
          return (
            <section key={step.number} className="section-padding py-14 sm:py-16 lg:py-20 border-b border-argos-gray-lighter">
              <div className="container-argos grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
                {/* Number + icon */}
                <div className="lg:col-span-4 flex items-start gap-6 lg:sticky lg:top-28">
                  <span className="text-7xl sm:text-8xl font-heading font-semibold text-argos-gray-lighter leading-none select-none">
                    {step.number}
                  </span>
                  <span className="mt-6 w-12 h-12 flex items-center justify-center bg-argos-black text-white shrink-0">
