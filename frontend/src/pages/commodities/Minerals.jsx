...
import { Mountain, Shield, Globe, BarChart3, Truck, Package } from 'lucide-react'
      ...
      <section className="section-padding py-20 lg:py-28 bg-argos-gray-lightest">
        <div className="container-argos">
          ...
          <div className="mb-12 overflow-hidden">
            <img
              src="/images/commodities/minerals-mining.jpg"
              alt="Mineral ore and mining output"
        ...
        <div className="container-argos">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="heading-section text-3xl lg:text-4xl mb-4">Have a minerals mandate?</h2>
              <p className="text-argos-gray-light text-base leading-relaxed">
                Tell us your volume, specification and timeline. Our desk will identify mineral tenders and cargo offers that match your requirements.
              </p>
            </div>
